...
class TestPayment(unittest.TestCase):
    ...
    def test_create_and_find(self):
        """
        Test Function: Payment create and find
        """
        card_token_object = {
    ...
    def test_create_raises_on_non_dict(self):
        """
        Test Function: Payment create raises ValueError on non-dict input
        """
        with self.assertRaises(ValueError):
            self.sdk.payment().create("not_a_dict")

    def test_update_raises_on_non_dict(self):
        """
        Test Function: Payment update raises ValueError on non-dict input
        """
        with self.assertRaises(ValueError):
            self.sdk.payment().update(12345, "not_a_dict")
