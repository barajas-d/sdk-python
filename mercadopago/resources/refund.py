...
class Refund(MPBase):
    ...
    def get(self, payment_id, refund_id, request_options=None):
        """Retrieves a specific refund by payment ID and refund ID.
